%% This geometry inherits the double-overdeepening geometry, but with a rising 
...
degree = 0; % basal elevation rotation degree
...
hp = [0, 3]; % at the ice shelf front, the height is 15 m
if hp(2) > ep(2)
...
syn_4.s = syn_s;
syn_4.h = syn_h;
syn_4.ocean_mask = ocean_mask;
syn_4.ice_mask   = ice_mask;
syn_4.end_year   = melt_years{end};
syn_4.fric_coef = fric_coef;
syn_4.shelf_melt.transient_melt = transient_melt;
syn_4.shelf_melt.constant_melt  = constant_melt;
syn_4.shelf_melt.melt_years     = melt_years;
syn_4.SMB = SMB;
syn_4.description = 'Calving on the Ridge type (CR) as described in Wood et al., 2021, with rising basal elevation upstream';
save('Synthetic glaciers/syn_4','syn_4')
