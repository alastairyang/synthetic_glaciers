...
syn_0.s = syn_s;
syn_0.h = syn_h;
syn_0.ocean_mask = ocean_mask;
syn_0.ice_mask   = ice_mask;
syn_0.end_year   = melt_years{end};
syn_0.fric_coef  = fric_coef;
syn_0.transient_fric_coef = transient_fric_coef;
syn_0.shelf_melt.transient_melt = transient_melt;
syn_0.shelf_melt.constant_melt  = constant_melt;
syn_0.shelf_melt.melt_years     = melt_years;
syn_0.SMB_grad = SMB_grad;
syn_0.SMB_cons = SMB_cons;
syn_0.rheoB = rheoB;
syn_0.transient_rheoB = transient_rheoB;
syn_0.description = 'Parabolic trunk. No basal perturbation';
save('Synthetic glaciers/syn_0','syn_0')

%% Save the perturbed forcings for sensitivity runs
%sens_3.shelf_melt = sens_shelf_melt;
sens_0.fric_coef  = sens_fric_coef;
sens_0.rheoB      = sens_rheoB;
% count the exisiting number of fields (must be before N_test)
N_vars = numel(fieldnames(sens_0));
sens_0.N_vars     = N_vars;

sens_0.N_test     = N_sens;
