...
%  Wider than No0. Width: No01 > No0 > No00
%% define parameters
% Geometry parameters
max_len = 400; % cutoff distance of flowline, in km
n = 150; % sine wave sampling points
ap_coef = 0.05; % filler wave amplitude
tot_wid = 17400*2; %  total width of this synthetic fjord
elev_bench = 450; % zero benchmark line for parabola
fjord_width = 7200*2; % fjord valley width in meter. must be even numbers and multiples of 2n
tot_length = 100000; % total glacier length
shear_length = 30000; % shear margin length
...
syn_01.Y = Y;
syn_01.bed = syn_b;
syn_01.base = syn_base;
syn_01.s = syn_s;
syn_01.h = syn_h;
syn_01.ocean_mask = ocean_mask;
syn_01.ice_mask   = ice_mask;
syn_01.end_year   = melt_years{end};
syn_01.fric_coef  = fric_coef;
syn_01.transient_fric_coef = transient_fric_coef;
syn_01.shelf_melt.transient_melt = transient_melt;
syn_01.shelf_melt.constant_melt  = constant_melt;
syn_01.shelf_melt.melt_years     = melt_years;
syn_01.SMB_grad = SMB_grad;
syn_01.SMB_cons = SMB_cons;
syn_01.rheoB = rheoB;
syn_01.transient_rheoB = transient_rheoB;
syn_01.description = 'Parabolic trunk. No basal perturbation';
save('Synthetic glaciers/syn_01','syn_01')

%% Save the perturbed forcings for sensitivity runs
%sens_3.shelf_melt = sens_shelf_melt;
sens_01.fric_coef  = sens_fric_coef;
sens_01.rheoB      = sens_rheoB;
% count the exisiting number of fields (must be before N_test)
N_vars = numel(fieldnames(sens_01));
sens_01.N_vars     = N_vars;

sens_01.N_test     = N_sens;
save('Sensitivity/sens_01','sens_01')